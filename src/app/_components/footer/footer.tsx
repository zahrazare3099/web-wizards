...
export const Footer = () => {
  return (
    <div className="bg-base-200 text-base-content border-t dark:border-base-content dark:border-opacity-5">
      <footer className="container flex flex-col  lg:flex-row items-center gap-5 px-0  lg:px-12 xl:px-40 py-5">
      ...
      <div
        className="text-left pb-8 flex flex-1 flex-col md:flex-row md:items-center md:justify-between"
        lang="en"
        dir="ltr"
      >
        <div className="container pb-10 mx-auto gap-5 px-0 lg:px-12 xl:px-40 flex justify-between items-center">
