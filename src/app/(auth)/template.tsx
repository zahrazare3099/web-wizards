...
export default function AuthTemplate({
  ...
  return (
    <div className="fade-in container pl-0 flex max-w-5xl dark:bg-base-50 my-8 rounded-lg border dark:border-base-content dark:border-opacity-10 shadow-md dark:bg-opacity-20">
